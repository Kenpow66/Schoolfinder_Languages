...
#Pivot longer but keeping the campus ID
  languages_long <- pivot_longer(Languages, cols = -entity_id, names_to = "value", values_to = "Offered" ) 
...
write.csv(languages_final, "R:\\Specialists Transfer\\Ken\\GitHub\\Schoolfinder_Languages\\Languages_final.csv", row.names=FALSE)
```
